...
history = resnet152_model.fit_generator(train_generator,
                                        epochs=30,
                                        verbose=1,
...
if not os.path.exists(target_dir):
  os.mkdir(target_dir)
resnet152_model.save(target_dir + 'resnet152_model.h5')
resnet152_model.save_weights(target_dir + 'resnet152_weights.h5')
...
#plt.show()
fig.savefig('.../Accuracy_curve_resnet152_drop_batch_256.jpg')
...
fig2.savefig('.../Loss_curve_resnet152_drop_batch_256.jpg')
